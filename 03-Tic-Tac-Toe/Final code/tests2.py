...
def insert_move(coordinates, perm_gs):
    game_index_to_insert = linear_search(perma_coords, coordinates)
    perm_gs[game_index_to_insert] = "X"
    return perm_gs
...
var = valid_input(valid_coordinates, perma_coords)
print(var)
print(perma_coords)
print(linear_search(valid_coordinates, var))
print_game(insert_move(var, perm_gs))
